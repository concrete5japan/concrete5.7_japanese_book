...
class UtilTests extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Concrete\Flysystem\Config', Util::ensureConfig(array()));
        $this->assertInstanceOf('Concrete\Flysystem\Config', Util::ensureConfig('string'));
        $this->assertInstanceOf('Concrete\Flysystem\Config', Util::ensureConfig(null));
        $this->assertInstanceOf('Concrete\Flysystem\Config', Util::ensureConfig(new Config));
    }
